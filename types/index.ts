...
export interface SiteConfig {
  ...
  rsvp_titulo: string;
  rsvp_boton_abrir: string;
  rsvp_boton_enviar: string;
  rsvp_boton_enviando: string;
  rsvp_boton_si: string;
  rsvp_boton_no: string;
  rsvp_pregunta: string;
  rsvp_gracias_titulo: string;
  rsvp_gracias_texto: string;
  rsvp_label_nombre: string;
  rsvp_label_apellido: string;
  rsvp_label_cargo: string;
  rsvp_label_institucion: string;
  rsvp_label_telefono: string;
  rsvp_label_email: string;
