...
alter table public.configuracion add column if not exists rsvp_boton_abrir text default '';
alter table public.configuracion add column if not exists rsvp_boton_enviar text default '';
alter table public.configuracion add column if not exists rsvp_boton_enviando text default '';
alter table public.configuracion add column if not exists rsvp_boton_si text default '';
alter table public.configuracion add column if not exists rsvp_boton_no text default '';
alter table public.configuracion add column if not exists rsvp_pregunta text default '';
alter table public.configuracion add column if not exists rsvp_gracias_titulo text default '';
alter table public.configuracion add column if not exists rsvp_gracias_texto text default '';
alter table public.configuracion add column if not exists rsvp_label_nombre text default '';
alter table public.configuracion add column if not exists rsvp_label_apellido text default '';
alter table public.configuracion add column if not exists rsvp_label_cargo text default '';
alter table public.configuracion add column if not exists rsvp_label_institucion text default '';
alter table public.configuracion add column if not exists rsvp_label_telefono text default '';
alter table public.configuracion add column if not exists rsvp_label_email text default '';
